    ...
    public $modules = [
        {
            ...
            children: [
                {
                    name: 'QuickClaim',
                    routerLink: '/claims/quick-claim',
                    authorization: {
                        allowedRoles: []
                    }
                },
                {
                    name: 'QuickClaimSimple',
                    routerLink: '/claims/quick-claim-simple',
                    authorization: {
                        allowedRoles: []
                    }
                }
        ...
        },
        {
            ...
            label: '',
            labelKey: 'modules.Policies.label',
            name: 'Policies',
            url: 'policies',
            children: [] as View[]
        },
        {
            ...
            label: '',
            labelKey: 'modules.MainSite.label',
            name: 'MainSite',
            url: 'main-site',
            children: [
                {
                    name: 'Wrapper',
                    routerLink: '/main-site/wrapper',
                    authorization: {
                        allowedRoles: []
                    }
                }
